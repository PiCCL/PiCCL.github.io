...
\r
const plate = new PICCL.Picture({url:clockPlateUrl,width:700})\r
    .shadowEffect(-10,-4,4)\r
\r
const arm = new PICCL.Picture({url:clockArmUrl,height:760})\r
    .shadowEffect(-5,-4,4)      \r
\r
const cp = PICCL.union([plate,circle])\r
    .pointSnap(plate,circle,{anchor:[0.5,0.5]})\r
\r
const cpa = PICCL.union([cp,arm])\r
    .pointSnap(cp,arm,{anchor:[0.5,0.5]})\r
\r
