...
\r
const flag = new PICCL.Picture({url: "Argentina.webp", width: 180}).mapValue("url", "logo")\r
\r
...
const colGlyph = PICCL.union([bar_with_star, text1])\r
    .pointSnap(text1, bar_with_star, { anchor: [0.5, 0], offset: [0, -50] })\r
\r
const colGlyph_with_flag = PICCL.union([colGlyph, flag]).pointSnap(flag, colGlyph, {sourceAnchor: [0.5, 0.5], targetAnchor:[0.5,0], offset:[0,-170]})\r
\r
