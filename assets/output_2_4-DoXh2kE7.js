...
\r
const star = new PICCL.Picture({url: "star.png", colorMode: "darkness", width: 50})\r
    .mapValue("color", "country", { palette: palette2 })\r
const starstack = PICCL.repeat(star, "count")\r
    .stackLayout("y", 100)\r
\r
const flag = new PICCL.Picture({width: 200})\r
    .mapValue("url", "logo")\r
\r
const text1 = new PICCL.Text({ fontSize: 30, textAnchor: "middle" })\r
    .mapValue("content", "country");\r
const colGlyph = PICCL.union([bar, text1, starstack, flag])\r
    .pointSnap(text1, bar, { anchor: [0.5, 0], offset: [0, -50] })\r
    .pointSnap(bar, starstack, {anchor: [0.5, 0], offset: [0, -50]})\r
    .pointSnap(flag, bar, {sourceAnchor: [0.5, 1], targetAnchor: [0.5, 0], offset: [0, -50]})\r
\r
