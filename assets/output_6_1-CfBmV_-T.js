...
const plate = new PICCL.Picture({url:clockPlateUrl, width:750}).shadowEffect(-4,-4,4)\r
const arm = new PICCL.Picture({url:clockArmUrl, width:750}).shadowEffect(-4,-4,4)\r
\r
...
const img = PICCL.union([plate, circle,arm]).pointSnap(arm,circle,{anchor:[0.5,0.5]}).pointSnap(circle,plate,{anchor:[0.5,0.5]})\r
await PICCL.show([\r
