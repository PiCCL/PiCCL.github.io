...
\r
const arm=new PICCL.Picture({url:clockArmUrl})\r
    .shadowEffect(-8,-8,5)\r
const clock=new PICCL.Picture({url:clockPlateUrl})\r
    .shadowEffect(-5,-5,10)\r
const circle = new PICCL.Circle({ r: 200, innerRadius: 120 });\r
\r
const clockWithCircle=PICCL.union([clock,circle,arm])\r
    .pointSnap(circle,clock,{anchor:[0.5,0.5]})\r
\r
